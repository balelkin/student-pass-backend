...
const Serialize = (role) => (proto, propName, descriptor) => {
    setSerializeType(proto[propName], role);
    common_1.UseInterceptors(common_1.ClassSerializerInterceptor)(proto, propName, descriptor);
    common_1.UseInterceptors(serialization_interceptor_1.default)(proto, propName, descriptor);
};
